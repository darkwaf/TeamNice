...
def populate():
    #movie title
    horror_mov = add_mov('Dracula', views=128, likes=64)
    comedy_mov = add_mov("Hang out with me", views=64, likes=32)
    document_mov = add_mov("One Direction", views=32, likes=16)
